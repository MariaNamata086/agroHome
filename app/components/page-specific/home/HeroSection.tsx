    ...
    <section className="flex relative h-auto w-full tracking-wider mt-2">
      ...
      >
        <div className="relative z-20 h-full flex flex-col md:mt-20 w-full md:w-[55%] gap-4 md:gap-14 tracking-wider leading-loose">
          ...
          <h1
            className={`font-bold text-xl md:text-5xl text-forestGreen leading-relaxed ${inView ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'} transform transition-transform ease-in-out duration-1500 delay-0`}
          >
