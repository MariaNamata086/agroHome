...
const ProjectCard = ({
  ...
  return (
    ...
    >
      ...
      />{' '}
      <div className="flex flex-col gap-5 justify-center items-center  w-[90%] z-10 p-3 md:px-4 -mt-22 bg-white">
        <h1 className="font-semibold tracking-widest text-xl md:text-[20px] text-stone-800">
          {projectName}
        </h1>
