...
function HeaderBanner({
  ...
  return (
    <div className=" h-100 md:h-120 w-full relative">
      <div className="z-20 text-slate-800 h-full bg-linear-to-r from-black/65 md:from-white md:via-slate-300/40 via-black/55 to-transparent w-full absolute flex-col gap-10">
